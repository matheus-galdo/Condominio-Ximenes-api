...
class ChatPortariaController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        if ($user->typeName->is_admin) {
            ...
            $proprietariosWithoutChat = ChatProprietariosResource::collection(Proprietario::doesntHave('chatPortaria')
    ...
    {
        $user = auth()->user();
        $userChat = ChatPortaria::with('mensagens.autor')->find($chatId);
